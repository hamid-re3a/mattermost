...
import { Button, Icon, Text, H2, Spinner } from 'native-base';
...
class LatePaymentLightbox extends React.Component {
    ...
    componentWillMount() {
        ...
        this.setState({
            step: 1,
            remaining_money: 0,
            payment_type: this.props.reserve.payment_type,
            current_reserve: this.props.reserve,
            payOnline: 0
        });
    ...
    async _getRequestReserve(payment_type) {
        try {
            let { service_id, date, start_time } = this.props.reserve;
    ...
    _renderPayStep() {
        ...
        var price = this.props.reserve.service_price;
        if (price < 1000)
            price = 1000;
    ...
    _renderFinalStep() {
        ...
        if (this.state.payOnline)
            return <View style={{ width: '100%', justifyContent: 'flex-start', alignItems: 'center', padding: 10 }}>
                ...
                <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center', padding: 10, marginTop: 40 }}>
                    ...
                    <TText  style={{color: 'white'}}>رزرو شما با موفقیت انجام شد در صورتی که اقدام به پرداخت مبلغ رزرو نکنید ، رزرو شما کنسل خواهد شد</TText>
        ...
        return <View style={{ width: '100%', justifyContent: 'flex-start', alignItems: 'center', padding: 10 }}>
            ...
            <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center', padding: 10, marginTop: 40 }}>
                ...
                <TText  style={{color: 'white'}}>رزرو شما با موفقیت انجام شد</TText>
    ...
    _renderLoadingStep() {
        ...
        return <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center', padding: 10 }}>
            <TText  style={{color: 'white'}}>لطفا اندکی صبر کنید</TText>
            <Spinner />
        </View>
    }
    ...
    _renderErrorStep() {
        ...
        return <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center', padding: 10 }}>
            <TText  style={{color: 'white'}}>امکان انجام این رزرو وجود ندارد</TText>
        </View>
    }
...
export default connect(mapStateToProps, null)(LatePaymentLightbox)